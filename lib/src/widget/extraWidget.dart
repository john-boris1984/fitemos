...
class ExtraWidget extends StatefulWidget {
  String timerWork;
  ExtraWidget({Key key, this.timerWork}) : super(key: key);

  @override
  _extraWidget createState() => _extraWidget();
}

class _extraWidget extends State<ExtraWidget>
