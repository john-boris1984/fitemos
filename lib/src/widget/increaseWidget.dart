...
class IncreaseWidget extends StatefulWidget {
  String timerWork;
  IncreaseWidget({Key key, this.timerWork}) : super(key: key);

  @override
  _increaseWidget createState() => _increaseWidget();
}

class _increaseWidget extends State<IncreaseWidget>
    ...
    if (showTitle) {
      if (!initFlag) {
        setState(() {
          fontVal = 16;
          timeText =
              'Tiempo Límite: ${minutes.toString().padLeft(2, '0')}:${seconds.toString().padLeft(2, '0')} minutos.';
        });
      } else {
        setState(() {
                ...
                ? buttonText == 'Start'
                    ? Container(
                        ...
                        child: RichText(
                            textAlign: TextAlign.center,
                            text: TextSpan(
                                text: 'Completar en el menor tiempo posible.',
                                style: GoogleFonts.rubik(
                                    fontSize: fontVal,
